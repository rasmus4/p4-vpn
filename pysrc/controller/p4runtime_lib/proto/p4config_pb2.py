...
_P4DEVICECONFIG_EXTRAS_KVENTRY.has_options = True
_P4DEVICECONFIG_EXTRAS_KVENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
try:
